# Novoplasty
We can generate complete mtDNA genomes using the raw fastq files and software called Novoplasty.  I did this already for the Liberia sequence in this directory:
```
/home/ben/projects/rrg-ben/ben/2022_Liberia/Liberia/bad_trim_fq
```
using this config file:
```
Project:
-----------------------
Project name          = ROM19161_Liberia_denovo_mtDNA
Type                  = mito
...
Seed Input            = /home/ben/projects/rrg-ben/ben/2020_mellotrop_RNA/Germany_genome/raw_data/XT_complete_mtDNA_genome.fasta
Extend seed directly  = no
Reference sequence    = /home/ben/projects/rrg-ben/ben/2020_mellotrop_RNA/Germany_genome/raw_data/XT_complete_mtDNA_genome.fasta
Variance detection    = 
...
Single/Paired         = PE
Combined reads        = 
Forward reads         = ./ROM19161_trim_R1.fq.gz
Reverse reads         = ./ROM19161_trim_R2.fq.gz
Store Hash            =
...
```
And this is the filename of the circularized mtDNA genome for Liberia:
```
