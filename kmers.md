...
```
sbatch 2021_cookiecutter_extract.sh ../raw_data/XT7_WY_trim_noadapters/XT7_WY_trim_no_adapt.R1.fq ../raw_data/XT7_WY_trim_noadapters/XT7_WY_trim_no_adapt.R1.fq ../raw_data/XT7_WY_minus_XT11_WW_minus_XT10_WZ_putative_reallyreally_Y_specific.out_printed.out_printed_filtered_gt_2_lt_100.out_seqs.fa ../raw_data/XT7_WY_minus_XT11_WW_minus_XT10_WZ_putative_reallyreally_Y_specific.out_printed.out_printed_filtered_gt_2_lt_100.out_fq_filez
```
```
